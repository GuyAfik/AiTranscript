...
class AICleanupService:
    ...
    def __init__(
        self, api_key: Optional[str] = None, model: str = "llama2", provider: str = "local"
    ) -> None:
        """
    ...
    def _call_local_llm(self, system_prompt: str, user_message: str, temperature: float) -> str:
...
Focus on the most important information and maintain clarity."""
        ...
        return self._call_api(
            system_prompt=system_prompt, user_message=user_message, max_tokens=2000, temperature=0.7
        )
...
Maintain the original meaning and tone. Keep the content natural and conversational."""
        ...
        return self._call_api(
            system_prompt=system_prompt, user_message=user_message, max_tokens=3000, temperature=0.5
        )
...
Each point should be concise but complete. Aim for 3-7 key points."""
        ...
        response = self._call_api(
            system_prompt=system_prompt, user_message=user_message, max_tokens=1000, temperature=0.7
        )
    ...
    def refine_message(
        self, text: str, tone: str = "professional", recipient_context: Optional[str] = None
    ) -> str:
        """
